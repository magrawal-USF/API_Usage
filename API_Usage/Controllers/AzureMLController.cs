  ...
  public class AzureMLController : Controller
  {
    ...
    static async Task<AzureMLModel> InvokeRequestResponseService()
    {
      ...
      using (var client = new HttpClient())
      {
        ...
        client.BaseAddress = new Uri("https://ussouthcentral.services.azureml.net/workspaces/66a8bd564d2349b7ba3123986f38f907/services/d3ebe90fcbaa42acaed474a2675d4b56/execute?api-version=2.0&details=true");
